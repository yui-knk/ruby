...
[[  /* Default location. */
  ...
  /*
   * Checking enough recovery tokens are generated by looking next recovery_tokens.
   * It is better to check the rule used to reduce is same with the rule by which
