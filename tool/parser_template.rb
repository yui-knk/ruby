...
module Prism
  module Template
    ...
    class NodeKindField < Field
      ...
      def c_type
        if specific_kind
          "rb_#{specific_kind.gsub(/(?<=.)[A-Z]/, "_\\0").downcase}"
        else
          "rb_node"
        end
      end
      ...
      def render(name, write_to: nil)
        ...
        heading =
          ...
          when ".rb"
            ...
            =begin
            --
            This file is generated by the tool/parser_template.rb script and should not be
          ...
          when ".rbi"
            ...
            /*----------------------------------------------------------------------------*/
            /* This file is generated by the tool/parser_template.rb script and should not*/
