...
rb_parsey_s_yytname(VALUE module)
{
    ...
    for (unsigned long i = 0; i < l; i++) {
        rb_ary_push(ary, rb_fstring_cstr(yytname[i]));
    }
...
Init_Parsey(void)
{
    ...
    rb_define_singleton_method(rb_mParsey, "yydefact", rb_parsey_s_yydefact, 0);
    rb_define_singleton_method(rb_mParsey, "yypgoto", rb_parsey_s_yypgoto, 0);
    rb_define_singleton_method(rb_mParsey, "yydefgoto", rb_parsey_s_yydefgoto, 0);
    rb_define_singleton_method(rb_mParsey, "yytable", rb_parsey_s_yytable, 0);
    rb_define_singleton_method(rb_mParsey, "yycheck", rb_parsey_s_yycheck, 0);
